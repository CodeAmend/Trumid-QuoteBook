...
function FormView() {
  ...
  const disabled: boolean = !(selectState.price > 0 && selectState.qty > 0);

  return(
    <form>
      <button disabled={disabled} type="button" onClick={handleAddOrder}>Add</button>
      <select name="bond" value={selectState.bondId} onChange={handleSelect}>
